...
define(['lodash', 'jquery', 'rivets', 'moment', 'jquery-ui', 'jquery-sparkline', 'color-picker'], function (_, $, rv, moment) {
    ...
    /*************************************  binding *****************************************/
    /*binder for adding and updating colorpicker*/
    rv.binders.colorpicker = {
        ...
        routine: function(el, value){
            ...
            $(el).val(value).css("background", value).css("color", value);
        }
    }
